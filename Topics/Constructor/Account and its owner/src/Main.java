...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Account account1 = new Account("123456", 1000, new User("demo-user", "Alexander",
                "Schmidt")); // create an instance of Account here

        process(account1); // pass it into process method
    }
